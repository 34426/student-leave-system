...
<div class="sidebar-wrap">
  ...
  <div class="search-wrap">
            <div class="search-content">
                <form action="notice_notice.do" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">内容:</th>
                            <td><input class="common-text" placeholder="名称" name="content" value="${noticeInfo.content}" id="" type="text"></td>
        ...
        <div class="result-wrap">
                <div class="result-title">
                    <div class="result-list">
                        <a href="${ctx}/notice_add.do"><i class="icon-font"></i>新增</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                         ...
                         <tr>
                            <td>${spe.content}</td>
                             <td>${spe.createTime}</td>
                            <td>
                                <a class="link-update" href="${ctx}/notice_update.do?id=${spe.id}">修改</a>
                                <a class="link-del" href="${ctx}/notice_delete.do?id=${spe.id}">删除</a>
                            </td>
                        </tr>
                         </c:forEach>
                    </table>
			      ...
			      <pg:pager  url="${ctx}/notice_notice.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
					<pg:param name="content" value="${noticeInfo.content}"/>
					<pg:last>  
