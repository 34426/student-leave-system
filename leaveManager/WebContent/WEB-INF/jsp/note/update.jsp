	...
	private int isDelete;//是否删除 1是 2否 -->
        <div class="result-wrap">
            <div class="result-content">
                <form action="note_exUpdate.do" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody>
                           ...
                           <input type="hidden" name="id" value="${c.id}">
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="${c.title}" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th>请假类型：</th>
                                <td>
                                <c:if test="${c.type == 1}">
                                 事假<input class="common-text" name="type" size="50" value="1" type="radio" checked="checked">
                                </c:if>
                                <c:if test="${c.type != 1}">
                                 事假<input class="common-text" name="type" size="50" value="1" type="radio">
                                 </c:if>
                                <c:if test="${c.type == 2}">
                                                                                             病假<input class="common-text" name="type" size="50" value="2" type="radio" checked="checked">
                               </c:if>
                                <c:if test="${c.type != 2}">
                                                                                             病假<input class="common-text" name="type" size="50" value="2" type="radio">
                               </c:if>
                             ...
                             <th>陈述内容：</th>
								...
								<!-- 加载编辑器的容器 -->
							        <script id="remark_txt_1" name="content" type="text/plain" style="width:1100px;height:500px;">${c.content}</script>
								    <!-- 实例化编辑器 -->
                              ...
                              <tr >
                                <th>时间区间：</th>
                               <td>
                            开始时间：<input id="txtBeginDate" name="startTime" value="${c.startTime}" style="width:170px;padding:7px 10px;border:1px solid #ccc;margin-right:10px;"/>
                           结束时间： <input id="txtEndDate" name="endTime" value="${c.endTime}" style="width:170px;padding:7px 10px;border:1px solid #ccc;" />
                            </td>
                            </tr>
                            <tr>
                                <th></th>
