	...
	private int isDelete;//是否删除 1是 2否 -->
        <div class="result-wrap">
                <div class="result-content">
			      ...
			      <pg:pager  url="${ctx}/note_studentList.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
					<pg:param name="studentId" value="${studentId}"/>
					<pg:last>  
