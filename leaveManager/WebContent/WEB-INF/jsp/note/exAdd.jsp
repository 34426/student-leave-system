	...
	private String content; -->
        <div class="result-wrap">
            <div class="result-content">
                <form action="note_add.do" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                             ...
                             <tr>
                                <th>请假类型：</th>
                                <td>事假<input class="common-text" name="type" size="50" value="1" type="radio">
                                                                                             病假<input class="common-text" name="type" size="50" value="2" type="radio"></td>
                            </tr>
                             <tr>
                             <th>陈述内容：</th>
	                             <td>
                              ...
                              <tr >
                                <th>时间区间：</th>
                               <td>
                            开始时间：<input id="txtBeginDate" name="startTime" value="" style="width:170px;padding:7px 10px;border:1px solid #ccc;margin-right:10px;"/>
                           结束时间： <input id="txtEndDate" name="endTime" value="" style="width:170px;padding:7px 10px;border:1px solid #ccc;" />
                            </td>
                            </tr>
                            <tr>
                                <th></th>
