...
<div class="container clearfix">
  ...
  <div class="search-wrap">
            <div class="search-content">
                <form action="note_note.do" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">名称:</th>
                            <td><input class="common-text" placeholder="名称" name="student.realName" value="${noteInfo.student.realName}" id="" type="text"></td>
	...
	private int isDelete;//是否删除 1是 2否 -->
        <div class="result-wrap">
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                 <a class="link-del" href="${ctx}/note_detail.do?id=${spe.id}">办理</a>
                            </td>
                        </tr>
                         </c:forEach>
                    </table>
			      ...
			      <pg:pager  url="${ctx}/note_note.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
