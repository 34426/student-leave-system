...
<div class="container clearfix">
  ...
  <div class="search-wrap">
            <div class="search-content">
                <form action="student_student.do" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">姓名:</th>
                            <td><input class="common-text" placeholder="名称" name="realName" value="${student.realName}" id="" type="text"></td>
                ...
                <div class="result-title">
                  <c:if test="${type == 1 }">
                   <div class="result-list">
                        <a href="${ctx}/student_add.do"><i class="icon-font"></i>新增</a>
                    </div>
                  </c:if>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                         ...
                         <tr>
                            <td>${spe.classRoom.college}</td>
                             <td>${spe.classRoom.major}</td>
                               <td>${spe.classRoom.name}</td>
                               <td>${spe.xh}</td>
                                <td>${spe.name}</td>
                               <td>${spe.realName}</td>
                               <td>
                            ...
                            <td>
                              <c:if test="${type == 1 }">
                                <a class="link-update" href="${ctx}/student_update.do?id=${spe.id}">修改</a>
                                <a class="link-del" href="${ctx}/student_delete.do?id=${spe.id}">删除</a>
                                </c:if>
                                 <a class="link-update" href="${ctx}/note_studentList.do?studentId=${spe.id}">请假信息</a>
                            </td>
                        </tr>
                         </c:forEach>
                    </table>
			      ...
			      <pg:pager  url="${ctx}/student_student.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
					<pg:param name="realName" value="${student.realName}"/>
					<pg:last>  
