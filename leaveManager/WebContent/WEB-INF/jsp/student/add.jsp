	...
	private int isDelete;//是否删除 1是 2否 -->
        <div class="result-wrap">
            <div class="result-content">
                <form action="student_exAdd.do" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>真实名：</th>
                                <td><input class="common-text" name="realName" size="50" value="" type="text"></td>
                            </tr>
                             <tr>
                                <th>学号：</th>
                                <td><input class="common-text" name="xh" size="50" value="" type="text"></td>
                            </tr>
                             <tr>
                                <th>性别：</th>
                                <td>男<input class="common-text" name="sex" size="50" value="1" type="radio">
                                                                                              女<input class="common-text" name="sex" size="50" value="2" type="radio"></td>
                            </tr>
                             <tr>
                                <th>班级：</th>
                                <td>
