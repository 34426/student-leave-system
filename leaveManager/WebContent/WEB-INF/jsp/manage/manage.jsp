    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                ...
                <li><a href="http://www.y-one.cn/" target="_blank">网站首页</a></li>
            </ul>
        </div>
...
<div class="container clearfix">
  ...
  <div class="search-wrap">
            <div class="search-content">
                <form action="manage_manage.do" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">名称:</th>
                            <td><input class="common-text" placeholder="名称" name="realName" value="${manage.realName}" id="" type="text"></td>
        ...
        <div class="result-wrap">
                <div class="result-title">
                    <div class="result-list">
                        <a href="${ctx}/manage_add.do"><i class="icon-font"></i>新增</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <a class="link-update" href="${ctx}/manage_update.do?id=${spe.id}">修改</a>
                                <a class="link-del" href="${ctx}/manage_delete.do?id=${spe.id}">删除</a>
                            </td>
                        </tr>
                         </c:forEach>
                    </table>
			      ...
			      <pg:pager  url="${ctx}/manage_manage.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
					<pg:param name="realName" value="${classRoom.realName}"/>
					<pg:last>  
