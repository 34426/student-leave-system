    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a href="login_index.do">修改密码</a></li>
                <li><a href="#">退出</a></li>
            </ul>
        </div>
    </div>
	...
	private int isDelete;//是否删除 1是 2否 -->
        <div class="result-wrap">
            <div class="result-content">
                <form action="classRoom_exAdd.do" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>学院：</th>
                                <td>
                                    <input class="common-text required" id="title" name="college" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>专业：</th>
                                <td><input class="common-text" name="major" size="50" value="" type="text"></td>
                            </tr>
                             <tr>
                                <th>名称：</th>
