	...
	private int isDelete;//是否删除 1是 2否 -->
        <div class="result-wrap">
            <div class="result-content">
                <form action="classRoom_exUpdate.do" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody>
                           ...
                           <input type="hidden" name="id" value="${c.id}">
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="college" size="50" value="${c.college}" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>专业：</th>
                                <td><input class="common-text" name="major" size="50" value="${c.major}" type="text"></td>
                            </tr>
                            <tr>
                                <th>名称：</th>
                                <td><input class="common-text" name="name" size="50" value="${c.name}" type="text"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
